...
def iniciarJ():
	...
	jugador1=simpledialog.askstring("Jugador","Nombre del Jugador 1: ")
	jugador2=simpledialog.askstring("Jugador","Nombre del Jugador 2: ")
...
def cambiar(num):
	...
	if t [num]=="N" and turno ==0:
		...
		listaBotones[num].config(bg="yellow")
		t[num]="O"
		turno=0
		turnoJugador.set("Turno : "+ jugador1)
...
def verificar():
	if (t[0]=="X" and t[1]=="X" and t[2]=="X") or (t[3]=="X" and t[4]=="X" and t[5]=="X") or (t[6]=="X" and t[7]=="X" and t[8]=="X"):
		...
		bloquear()
		messagebox.showinfo("Ganador", "Ganaste" + jugador1)
		...
		bloquear()
		messagebox.showinfo("Ganador", "Ganaste" + jugador2)
ventana = Tk()
